...
//                         return (
//                             <Col md={4} className="item-box" sm={6} xs={12} sm={6} xs={12} key={index}>  
        ...
        return (
            <div className="delop-tool">
                ...
                <div className="tool-content">
                    ...
                    <Tabs defaultActivesKey="1" onChange={callback} tabBarStyle="simple" className="demo1-tabs">
                        <TabPane  className="item" tab='常用' key="1">
                            <Row>
                                <Col md={4} className="item-box" sm={6} xs={12}>
